...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom">
	<a class="navbar-brand" href="index.jsp"><i class="fa fa-book"></i>WEB-NOTE</a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item"><a class="nav-link" href="ShowNotes.jsp"><i
					class="fa fa-address-book-o" aria-hidden="true"></i>Show Note</a></li>
		</ul>
		...
		<%
		UsersDetails user = (UsersDetails) session.getAttribute("userD");

			if (user != null) {
		%>

		<a href="" class="btn btn-light mx-2" data-toggle="modal"
			data-target="#exampleModal"><i class="fa fa-user-circle-o"></i><%=user.getName()%></a>
	...
	<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
		...
		<a href="login.jsp" class="btn btn-light mx-2"><i
			...
			class="btn btn-light"><i class="fa fa-user-plus"></i>Register</a>
		<%
		}
		%>
